                    ...
                    [
                      {
                        ...
                        style: "tableHeaderAddInfo",
                      },
                    ],
                    [
                      {
                        text: `${totales.comentario}`,
                        alignment: "left",
                        fontSize: 9,
                      },
                    ],
                  ...
                  parimpuesto
                    ...
                    .then((parimpuesto) => {
                      ...
                      if (movfactura != null) {
                        ...
                        var fechaNumeroAutorizacion = moment()
                          .tz("America/Guayaquil")
                          .format("DDMMYYYY");
                        var fechaCabeceraFactura = moment()
                          .tz("America/Guayaquil")
                          .format("DD/MM/YYYY");
                        var puntoEmision =
                        ...
                        fs.readFile("FirmaApProject.p12", (err, data) => {
                          ...
                          const guardarDatosBase = pool
                            ...
                            .then((detallesFinal) => {
                              console.log(
                                detallesFinal + "Datos base guardados"
                              );
                            });
                          ...
                          columns: [
                            {
                              ...
                              table: {
                                ...
                                body: [
                                  ...
                                  [
                                    {
                                      text: `${datosfactura.rows[0].comentario}`,
                                      alignment: "left",
                                      fontSize: 9,
                                    },
                                  ],
