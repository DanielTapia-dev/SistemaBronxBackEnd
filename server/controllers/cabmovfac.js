    ...
    const consultaFormasPago = pool.query(
        ...
        .then((detallesFormaPago) => {
            ...
            detallesFormaPago.rows.forEach((element) => {
                var aux = [element.nomformapago, { text: element.valorcobro, alignment: 'right' }];
            ...
            detalles.forEach((element) => {
                ...
                var aux = [{ text: element.idproducto.toString(), alignment: 'center' }, { text: element.nomproducto.toString(), alignment: 'left' }, { text: element.cantidad.toString(), alignment: 'right' }, { text: element.precio.toString(), alignment: 'right' }, { text: "0", alignment: 'right' }, { text: element.subtotal.toString(), alignment: 'right' }];
                body.push(aux);
            });
            ...
            var bodySumatoria = [
                [{ text: "Subtotal:" }, { text: `${totales.subtotal.toString()}`, alignment: 'right' }],
                [{ text: "Descuento:" }, { text: `0.00`, alignment: 'right' }],
                [{ text: "Subtotal 0%:" }, { text: `${totales.subtotaliva0.toString()}`, alignment: 'right' }],
                [{ text: "Subtotal: 12%:" }, { text: `${totales.subtotaliva12.toString()}`, alignment: 'right' }],
                [{ text: "IVA 12:" }, { text: `${totales.iva12.toString()}`, alignment: 'right' }],
                [{ text: "Valor a Pagar:" }, { text: `${totales.total.toString()}`, alignment: 'right' }],
            ];
                    ...
                    WHERE FAC.secmovcab = CC.secmovcab AND
                          ...
                          FAC.claveacceso = '${id}';`
                                    ...
                                    .then(detallesFormaPago => {
                                        ...
                                        var bodySumatoria = [
                                            [{ text: "Subtotal:" }, { text: `${datosfactura.rows[0].subtotal.toString()}`, alignment: 'right' }],
                                            [{ text: "Descuento:" }, { text: `0.00`, alignment: 'right' }],
                                            [{ text: "Subtotal 0%:" }, { text: `${datosfactura.rows[0].subtotaliva0.toString()}`, alignment: 'right' }],
                                            [{ text: "Subtotal: 12%:" }, { text: `${datosfactura.rows[0].subtotaliva12.toString()}`, alignment: 'right' }],
                                            [{ text: "IVA 12:" }, { text: `${datosfactura.rows[0].iva12.toString()}`, alignment: 'right' }],
                                            [{ text: "Valor a Pagar:" }, { text: `${datosfactura.rows[0].total.toString()}`, alignment: 'right' }],
                                        ];
                                        var documentDefinition = {
                                            pageMargins: [10, 10, 10, 10],
                                            content: [{
                                            ...
                                            },
                                            {
                                                ...
                                                { text: "\nFecha Emisión:  ", fontSize: 9, bold: true },
                                                { text: `${datosfactura.rows[0].createdAt.toLocaleDateString()}`, fontSize: 9, bold: false },
                                                ],
                                                absolutePosition: { x: 25, y: 345 },
                                            },
                                            {
